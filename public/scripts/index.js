$(function() {
  ...
  $(window).on('scroll', function() {
    ...
    if (pos2 > $('#sounds').offset().top) { highlightLink('sounds'); }
    if (pos2 > $('#writings').offset().top) { highlightLink('writings'); }
    if (pos2 > $('#contacts').offset().top ||
  ...
  $('.writings-wrap').hover(function() {
    $('.writings-wrap').not(this).addClass('fade');
    $(this).addClass("hover");
  }, function() {
    $(this).removeClass("hover");
    $('.writings-wrap').removeClass('fade');
  });
